...
class HallazgosController extends Controller
{
    public function guardarMemo(Request $request)
    {
        ...
        $request->validate([
            ...
            'anio' => 'required|integer', // Validar el campo de año
        ]);
        ...
        Memo::create([
            ...
            'anio' => $request->input('anio'), // Guardar el año
        ]);
        
        // Redirigir o mostrar un mensaje de éxito
          return redirect()->route('memo_ofico.index');
    }
    ...
    public function actualizarMemo(Request $request, $id)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Hallazgos actualizados correctamente.']);
    }

    public function eliminarMemo($id)
    {
        // Buscar el memo por ID
        $memo = Memo::findOrFail($id);
        ...
        // Devolver una respuesta JSON
        return response()->json(['success' => true, 'message' => 'Memo eliminado correctamente.']);
    }
}