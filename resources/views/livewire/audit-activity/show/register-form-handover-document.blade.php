 <div x-data="registerFormHandoverDocument" @if($hasHandoverDocument) x-on:saved.window="await $wire.$parent.load()" @endif>
    ...
    >
        <x-section-basic>
                    ...
                    @if($hasHandoverDocument and auth()->user()->can('handoverDocument.register'))
                        <section role="buttons" class="inset-0 flex ml-auto">
                            ...
                            >
                                ...
                                <svg 
                                    xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#434343"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/>
                                </svg>
                            </figure>      
                
                            <figure x-show="!isEditing" x-on:click="deleting()" x-ref="figureDelete" style="width: 6.5rem;"
                                class="flex items-center justify-between p-2 mr-2 transition-all bg-red-100 rounded-full hover:bg-red-200 active:bg-red-300" 
                            >
                                <p class="pl-2 font-semibold " x-ref="buttonDelete">Eliminar</p>
                                <svg 
                                    style="width: 24px!important" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/>
                                </svg>
                            </figure> 
            ...
            @if(!$hasHandoverDocument)
                <x-slot:footer>
                    @can('handoverDocument.register')
                        <x-button class="ml-4" type="submit">Guardar</x-button>
                    @endcan
                </x-slot>
            @endif
        </x-section-basic>
