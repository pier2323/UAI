<div class="flex flex-col flex-grow px-3 pt-3 pb-5 align-middle border shadow w-fit">
    ...
    <div class="w-full">
        ...
        {{-- todo cards --}}
        <div class="grid items-center content-center grid-cols-3 p-2 auto-rows-fr gap-x-8 gap-y-5 min-h-56 min-w-96" x-data="card()" x-on:saving.window='$wire.prepare(employees)'>
            ...
            <div class="w-1/2 bg-gray-200 border border-gray-200 rounded-full shadow justify-self-center h-1/2 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 active:bg-green-100"
