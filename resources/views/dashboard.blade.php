            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="icono">
                    <a href="{{ route('personal-uai.dashboard') }}">
                        <div>
                            <img src="/images/iconos/administracion.png" width="100px" height="100px"style="margin-left: 75px;margin-right: 80px;">
                    ...
                    <a href="{{ route('dashboard') }}">
                        <div>
                            <img src="/images/iconos/plan.png"  width="84px" height="100px" style="margin-left: 100px;margin-right: 80px;">
                            </button>
                    ...
                    <a href="{{ route('dashboard') }}">
                        <div>
                            <img src="/images/iconos/personal.png" width="100px" height="100px"style="margin-left: 100px;margin-right: 80px;">
                            </button>
                    ...
                    <a href="{{ route('dashboard') }}">
                        <div>
                            <img src="/images/iconos/Actas.png" width="100px" height="100px"style="margin-left: 100px;margin-right: 80px;">
                            </button>
                    ...
                    <a href="{{ route('dashboard') }}">
                        <div>
                            <img src="/images/iconos/Actuacion.png" width="110px" height="100px"style="margin-left: 100px;margin-right: 140px;">
                            </button>
